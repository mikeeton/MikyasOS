...
export function WorkspaceTopbar() {
  ...
  return (
    <>
      <header className="premium-surface sticky top-0 z-20 border-b bg-background/78">
        <div className="flex min-h-16 items-center gap-3 px-4 pl-20 sm:px-6 lg:pl-6">
          ...
          <button
            type="button"
            className="premium-focus hidden h-9 min-w-0 flex-1 max-w-xl items-center gap-2 rounded-md border border-input bg-background/70 px-3 text-left text-sm text-muted-foreground transition hover:max-w-2xl hover:bg-accent md:flex"
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              className="hidden gap-2 px-3 xl:inline-flex"
